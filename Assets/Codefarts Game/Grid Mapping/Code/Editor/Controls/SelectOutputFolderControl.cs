...
namespace Codefarts.GridMapping.Editor.Controls
{
    ...
    public class SelectOutputFolderControl
    {
        ...
        /// <summary>
        /// Holds a reference to the output path.
        /// </summary>
        [SerializeField]
        ...
        public SelectOutputFolderControl()
        {
            ...
            this.RestrictToAssetsFolder = true;
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the control will not navigate above the assets folder.
        /// </summary>
        /// <value>
        /// <c>true</c> if true will prevent folder browsing beyond hte asets folder; otherwise, <c>false</c>.
        /// </value>
        public bool RestrictToAssetsFolder { get; set; }
        ...
        public void SetOutputPath(string path)
        {
            ...
            if (this.RestrictToAssetsFolder)
            {
