...
namespace Codefarts.GridMapping.Editor.DrawingTools
{
    ...
    public class Pencil : IEditorTool<GridMapEditor>
    {
        ...
        /// </summary>
        private List<string> drawingRuleFiles;
        ...
        public void OnInspectorGUI()
        {
            ...
            if (this.showDrawingRules)
            {
                ...
                while (removedKeys.Count > 0)
                {
                    ...
                    this.drawingRuleFiles.Remove(file);
                }
            }
        ...
        public void Startup(GridMapEditor mapEditor)
        {
            ...
            this.drawingRuleFiles = new List<string>();

            // load drawing rules
            this.drawingRules.Clear();
            foreach (var file in this.drawingRuleFiles)
            {
        ...
        private void AddDrawingRule()
        {
            ...
            if (rules != null)
            {
                ...
                this.drawingRuleFiles.Add(file);
            }
        }
        ...
        private GameObject ApplyDrawingRules(GameObject prefab, Point gridPosition, int layer)
        {
            ...
            foreach (var pair in this.drawingRules)
            {
                ...
                foreach (var rule in pair.Value.Rules)
                {
                    ...
                    var sourceRulePrefab = Helpers.GetSourcePrefab(rule.Prefab);
                    var sourcePrefab = Helpers.GetSourcePrefab(prefab);
                    ...
                    if (passed && lower && upper)
                    {
                        ...
                        prefabToReturn = Helpers.PerformInstantiation(gameObject);
        ...
        private void DrawThePrefab()
        {
            ...
            var layerLocked= this.map.LayerLocked[this.editor.ActiveLayer];
            var layerVisible = this.map.LayerVisibility[this.editor.ActiveLayer];
            if (layerLocked || !layerVisible || !this.isDrawing)
            {
#if PERFORMANCE
                perf.Stop(PerformanceID.Draw);
#endif
