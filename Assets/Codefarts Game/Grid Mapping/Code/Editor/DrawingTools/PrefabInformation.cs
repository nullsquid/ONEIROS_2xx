...
namespace Codefarts.GridMapping.Editor.DrawingTools
{
    ...
    public class PrefabInformation : IEditorTool<GridMapEditor>
    {
        ...
        public void Update()
        {
            ...
            var sharedMaterialName = string.Empty;
            var materialName = string.Empty;

            if (renderer != null)
            {
                sharedMaterialName = renderer.sharedMaterial != null ? renderer.sharedMaterial.name : string.Empty;
                materialName = renderer.material != null ? renderer.material.name : string.Empty;
            }
