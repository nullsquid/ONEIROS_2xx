...
namespace Codefarts.CoreProjectCode.Settings
{
    ...
    public static class ValuesExtensionMethods
    {
        ...
        /// </summary>
        /// <typeparam name="TKey">Defines the index key type that will be use to identify the value.</typeparam>
        /// <typeparam name="T">The type of setting to retrieve.</typeparam>
        /// <param name="values">Reference to the <see cref="IValues{TKey}" /> implementation.</param>
        /// <param name="key">The key of the setting.</param>
        /// <param name="value">The value of the setting if successful.</param>
        /// <returns>
        ...
        {
            // if values is null throw exception
            if (values == null)
            {
                throw new ArgumentNullException("values");
            }

            // if it does not have a value set default return value and return false
