...
namespace Codefarts.CoreProjectCode.Settings
{
    ...
    public sealed class SettingsManager : IValues<string>
    {
        ...
        public IValues<string> Values
        {
            ...
            set
            {
                // unhook from value changed event
                var valuesRepo = this.values;
                if (valuesRepo != null)
                {
                    valuesRepo.ValueChanged -= this.ValuesChangedHandler;
                }

                this.values = value;

                // hook into value changed event
                valuesRepo = this.values;
                if (valuesRepo != null)
                {
                    valuesRepo.ValueChanged += this.ValuesChangedHandler;
                }
        ...
        /// </param>
        private void ValuesChangedHandler(object sender, ValueChangedEventArgs<string> e)
        {
